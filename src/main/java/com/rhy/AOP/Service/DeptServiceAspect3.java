...
@Order(1) //先进后出（栈顺序）
public class DeptServiceAspect3 {
    ...
    public void before(JoinPoint point){ //JoinPoint是被代理的方法，运行时的元数据
        System.out.println("DeptServiceAspect3 before......");
    }
    @After("pointcut())")
    public void after(){
        System.out.println("DeptServiceAspect3 after......");
    }
    @AfterReturning("pointcut()")
    public void afterReturning(){
        System.out.println("DeptServiceAspect3 afterReturning...");
    }
    @AfterThrowing("pointcut()")
    public void afterThrowing(){
        System.out.println("DeptServiceAspect3 afterThrowing ...");
    }
}
