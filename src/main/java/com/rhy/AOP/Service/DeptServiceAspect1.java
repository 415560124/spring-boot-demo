...
@Order(2)
public class DeptServiceAspect1 {
    ...
    public void before(JoinPoint point){ //JoinPoint是被代理的方法，运行时的元数据
        System.out.println("DeptServiceAspect1 before......");
    }
    @After("pointcut())")
    public void after(){
        System.out.println("DeptServiceAspect1 after......");
    }
    @AfterReturning("pointcut()")
    public void afterReturning(){
        System.out.println("DeptServiceAspect1 afterReturning...");
    }
    @AfterThrowing("pointcut()")
    public void afterThrowing(){
        System.out.println("DeptServiceAspect1 afterThrowing ...");
    }
}
